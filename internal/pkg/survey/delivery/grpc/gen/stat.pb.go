...
func (x *GetSurveyReposnse) Reset() {
	*x = GetSurveyReposnse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetSurveyReposnse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSurveyReposnse) ProtoMessage() {}

func (x *GetSurveyReposnse) ProtoReflect() protoreflect.Message {
	mi := &file_stat_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSurveyReposnse.ProtoReflect.Descriptor instead.
func (*GetSurveyReposnse) Descriptor() ([]byte, []int) {
	return file_stat_proto_rawDescGZIP(), []int{2}
}

func (x *GetSurveyReposnse) GetQuestions() []*Question {
	if x != nil {
		return x.Questions
	}
	return nil
...
var file_stat_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x22, 0x22, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x53, 0x75, 0x72, 0x76, 0x65, 0x79, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x02, 0x49, 0x64, 0x22, 0x88, 0x01, 0x0a, 0x08, 0x51, 0x75, 0x65, 0x73, 0x74,
	...
	0x70, 0x6f, 0x73, 0x6e, 0x73, 0x65, 0x12, 0x2c, 0x0a, 0x09, 0x51, 0x75, 0x65, 0x73, 0x74, 0x69,
	...
	0x65, 0x79, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x2e, 0x5a, 0x2c,
...
var file_stat_proto_goTypes = []interface{}{
	...
	(*GetSurveyReposnse)(nil), // 2: note.GetSurveyReposnse
}
var file_stat_proto_depIdxs = []int32{
	1, // 0: note.GetSurveyReposnse.Questions:type_name -> note.Question
	0, // 1: note.Stat.GetSurvey:input_type -> note.GetSurveyRequest
	2, // 2: note.Stat.GetSurvey:output_type -> note.GetSurveyReposnse
...
func file_stat_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_stat_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetSurveyReposnse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
