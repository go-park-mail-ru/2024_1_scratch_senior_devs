...
var file_stat_proto_rawDesc = []byte{
	...
	0x79, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x6e, 0x73, 0x65, 0x12, 0x2c, 0x0a, 0x09, 0x51, 0x75, 0x65,
	...
	0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x32, 0x77, 0x0a, 0x04, 0x53, 0x74, 0x61, 0x74, 0x12,
	...
	0x75, 0x72, 0x76, 0x65, 0x79, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12,
...
var file_stat_proto_goTypes = []interface{}{
	...
	(*GetSurveyReposnse)(nil), // 4: note.GetSurveyReposnse
}
var file_stat_proto_depIdxs = []int32{
	3, // 0: note.GetSurveyReposnse.Questions:type_name -> note.Question
	2, // 1: note.Stat.GetSurvey:input_type -> note.GetSurveyRequest
	0, // 2: note.Stat.Vote:input_type -> note.VoteRequest
	4, // 3: note.Stat.GetSurvey:output_type -> note.GetSurveyReposnse
